  ...
  useEffect(() => {
    try {
      ...
      if (Date.now() >= jwtUser.exp * 1000) {
        ...
        // * 1000 done to convert into milliseconds, date.now returns in milliseconds
  ...
  return (
    <UserContext.Provider value={user}>
      <CartContext.Provider
        value={{ cart, addToCart, removeFromCart, updateCart, dispatchCart }}
      >
        {/* cart:cart , addToCart: addToCart , removeFromCart: removeFromCart and so on.. */}
        {/* value passed here(user) will be provided to useContext hook in Cartpage.jsx , there we can use that value */}
        <div className="app">
          <Navbar />
          <main>
